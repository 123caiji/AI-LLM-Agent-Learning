...
2020    LLM 兴起(GPT-3),涌现出 in-context learning
   ↓
2023-03 ReAct 论文发表,LLM Agent 范式确立
   ↓
2023-06 OpenAI Function Calling 推出,工具调用标准化
   ↓
2023-10 AutoGPT/BabyAGI 爆火,自主 Agent 概念普及
   ↓
...
> Anthropic 官方在《Building Effective Agents》一文中提出的 5 种 Workflow 模式,是 Agent 编排的基础范式。
...
# 定义 Guardrail
@guardrail
def check_input(input_text: str) -> bool:
    """检查输入是否安全"""
...
trainset = [
    dspy.Example(question="什么是 MCP?", answer="MCP 是...").with_inputs("question"),
    # ... 更多示例
]
