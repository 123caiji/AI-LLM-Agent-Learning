...
> 全套合计 **~25,200 行** Markdown,涵盖 **460+ 速查术语**、**540+ 表格/图示**、**580+ 代码/命令/配置示例块**。
...
> 📌 **专题篇:** `12-主流Agent对比分析.md`、`13-自托管个人Agent.md`、`14-多模态Agent.md` 不属于四层结构——前两篇是原理知识的"市场落点"(2026 年产品/框架/平台选型对比、OpenClaw 与 Hermes 自托管架构与安全实战),第三篇是多模态方向的深化笔记(VLM 原理、GUI 操作 Agent、端到端语音),回答"学完原理后该买/用/装哪个"以及"Agent 如何长出眼睛和耳朵"。
...
| **合计** | **~25,200** | **468(速查表)** | **540+ 表格** | **580+ 代码块** | ✅ |
