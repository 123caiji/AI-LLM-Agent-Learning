...
15 章知识体系 · 540+ 术语速查 · 680+ 对比表格 · 670+ 代码示例 · 可运行的 LangGraph 实战项目
...
[🚀 推荐学习路径](#四推荐学习路径4-种顺序) · [💻 实战项目](examples/personal-research-agent/) · [📊 版本日志](#十五文档统计与版本日志) · [🤝 参与贡献](CONTRIBUTING.md) · [💬 讨论区](https://github.com/123caiji/AI-LLM-Agent-Learning/discussions)
...
- 💬 **欢迎指正:** 任何错误、建议、补充都欢迎通过 Issue 或 PR 提出,作者会虚心接受并改进。文中引用的论文与链接以官方来源为准,如有错漏欢迎指正。
...
- [📅 十四、技术版本基准(2026-09)](#十四技术版本基准2026-09)
...
> 全套合计 **~27,550 行** Markdown,涵盖 **545 速查术语**、**645+ 表格/图示**、**655+ 代码/命令/配置示例块**。
...
| 技术/规范 | 版本/日期 | 说明 |
|----------|----------|------|
| **MCP 规范** | **2026-07-28(现行)** | 无状态架构、Extensions(Tasks/Skills/MCP Apps);2026-08-22 官方发布新版路线图 |
| **MCP 规范(历史)** | 2025-11-25 / 2025-03-26 / 2025-06-18 | 11-25:Tasks 原语(实验性)、URL 模式 Elicitation、CIMD;03-26:Streamable HTTP + OAuth 2.1;06-18:structuredContent |
| **A2A 协议** | v1.0(2026-03) | Google 发起;2026-08-17 迁入 Agentic AI Foundation (AAIF),与 MCP/AGENTS.md/goose 同基金会 |
| **Codex CLI** | 持续更新(以官方 release 为准) | approval_policy × sandbox_mode 审批模型;远程插件市场(2026-09) |
| **Claude Code** | 持续更新(以官方 release 为准) | 内置 Explore/Plan/General-purpose 三种 Subagent;Routines 定时任务 |
| **Gemini CLI** | 开源仓库持续更新 | 免费消费级入口 2026-06 起迁移至 Antigravity CLI |
...
| **推理引擎** | vLLM **v0.29.0** (2026-09-09) / SGLang **v0.5.20** (2026-09-05) | vLLM v0.25 起 Model Runner V2 默认、PagedAttention 移除;SGLang 已分拆为公司 RadixArk;**TGI 已归档只读(2026-03)**;另有 Ollama / TensorRT-LLM |
| **主流 LLM** | 2026-09 快照 | GPT-6 系列(Astra) / Claude 5 系列(Fable/Mythos) / Gemini 3.8 系列(Flash/Flash Cyber/Pro) / DeepSeek V4 家族(V4.1-Flash,2026-09-10) / Llama 4 / Qwen 3 |
...
|------|------|--------|--------|---------|------|
| 00 README | 本文件(~1730) | - | 6 | 0 | ✅ v5.7 |
| 01 交互入口 | 1,240 | 21 | 15+ | 25+ | ✅ v4 |
| 02 通信协议 | 2,184 | 30 | 30+ | 35+ | ✅ v5.7 |
| 03 智能体主体 | 2,114 | 40 | 35+(含 2 张自绘图) | 32+ | ✅ v4.8 |
| 04 能力与约束 | 1,240 | 30 | 15+ | 25+ | ✅ v4 |
| 05 任务编排 | 2,505 | 30 | 32+ | 40+ | ✅ v5.0 |
| 06 提示推理 | 1,947 | 30 | 28+ | 25+ | ✅ v5.0 |
| 07 记忆状态 | 1,939 | 34 | 22+ | 20+ | ✅ v5.7 |
| 08 RAG 体系 | 2,533 | 42 | 30+ | 35+ | ✅ v4 |
| 09 模型底座 | 2,546 | 62 | 36+ | 27+ | ✅ v5.7 |
| 10 部署运维 | 4,281 | 72 | 72+ | 78+ | ✅ v5.7 |
| 11 安全评估 | 2,826 | 50 | 35+ | 30+ | ✅ v5.7 |
| 12 Agent 对比(专题) | 1,089 | 20 | 15+(含 3 张自绘图) | 5+ | ✅ v5.7 |
| 13 自托管 Agent(专题) | 859 | 18 | 27(含 2 张自绘图) | 10+ | ✅ v5.7 |
| 14 多模态 Agent(专题) | 1,237 | 41 | 35+ | 4(完整示例) | ✅ v5.7 |
| 15 构建自己的Agent(专题) | 1,284 | 45 | 40+ | 10+(双版本完整代码) | ✅ v5.6 |
| **实战项目** | examples/(17 文件) | - | - | LangGraph 完整项目 | ✅ v5.6 |
| **合计(15 章正文)** | **29,824** | **565(速查表)** | **680+ 表格** | **670+ 代码块** | ✅ |
