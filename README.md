...
- [📁 一、文档结构总览(11 大类 + 4 专题 + README)](#一文档结构总览11-大类--4-专题--readme)
- [🗺️ 二、知识体系架构图](#二知识体系架构图)
- [📖 三、11 大类 + 4 专题一句话定位与深度内容](#三11-大类--4-专题一句话定位与深度内容)
...
| 技术/规范 | 版本/日期 | 说明 |
|----------|----------|------|
| **MCP 规范** | 2026-07-28(现行) | 无状态协议核心(废除握手/Session ID)、按请求能力协商、MRTR;Sampling/Roots/Logging 进入废弃期(SEP-2577);Tasks/MCP Apps 转为官方扩展 |
| **MCP 规范** | 2025-03-26 / 2025-06-18 | Streamable HTTP + OAuth 2.1(03-26);structuredContent、Elicitation(06-18) |
| **A2A 协议** | 2025-04 发布;1.0 于 2026-03-12 | Google 发起,2025-06 捐入 Linux Foundation;1.0 为首个稳定版(Signed Agent Cards、多租户) |
| **Codex CLI** | 持续更新(以官方 release 为准) | approval_policy × sandbox_mode 审批模型 |
| **Claude Code** | 持续更新(以官方 release 为准) | 内置 Explore/Plan/general-purpose 等 Subagent(另有 statusline-setup、claude-code-guide 等辅助 agent) |
...
| **主流 LLM** | - | GPT-6 Astra / Claude Fable 5.1 · Opus 5 / Gemini 3.x / Llama 4 / DeepSeek-V4 Pro·Flash / Qwen3.8 |
| **OWASP LLM Top 10** | 2026 版(2026-08-03) | 最新 LLM 应用安全风险,映射 NIST / MITRE ATLAS / CWE / OWASP Agentic Top 10 |
| **EU AI Act** | 2024-08-01 生效;2026-08-02 起大范围适用 | 全球首个综合 AI 监管法;禁令与 AI 素养条款 2025-02-02 适用、GPAI 规则 2025-08-02 适用、高风险系统 2027/2028 分阶段适用 |
...
| **合计** | **~29,600** | **655(速查表)** | **695+ 表格** | **675+ 代码块** | ✅ |
