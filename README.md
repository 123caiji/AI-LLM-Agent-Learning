...
> 按 11 大类系统组织 AI 全栈知识:**交互入口 → 通信协议 → 智能体主体 → 能力约束 → 任务编排 → 提示推理 → 记忆状态 → RAG 知识库 → 模型底座 → 部署运维 → 安全评估**,另加**专题篇《12-主流Agent对比分析》与《13-自托管个人Agent》**(2026-07 市场选型对比 + OpenClaw/Hermes 框架解读,含五张自绘对比图)。所有内容已对照 2026 年最新官方文档与社区实践整理。本 README 是整个知识体系的"地图 + 索引 + 学习指南",看完它你就能找到任何 AI 工程化概念的位置。
...
- 💬 **欢迎指正:** 任何错误、建议、补充都欢迎通过 Issue 或 PR 提出,作者会虚心接受并改进。
...
- [📁 一、文档结构总览(11 大类 + 2 专题 + README)](#一文档结构总览11-大类--2-专题--readme)
- [🗺️ 二、知识体系架构图](#二知识体系架构图)
- [📖 三、11 大类 + 2 专题一句话定位与深度内容](#三11-大类--2-专题一句话定位与深度内容)
...
> 全套合计 **~24,200 行** Markdown,涵盖 **430+ 速查术语**、**510+ 表格/图示**、**570+ 代码/命令/配置示例块**。
...
> 📌 **专题篇:** `12-主流Agent对比分析.md` 与 `13-自托管个人Agent.md` 不属于四层结构,它们是原理知识的"市场落点"——前者做 2026 年产品/框架/平台选型对比,后者深挖 OpenClaw(小龙虾)与 Hermes Agent(爱马仕)的自托管架构、对比与安全实战,回答"学完原理后该买/用/装哪个"。

---

## 三、11 大类 + 2 专题一句话定位与深度内容
...
| **合计** | **~24,200** | **429(速查表)** | **510+ 表格** | **570+ 代码块** | ✅ |
...
- [ ] 增加 14 章:`14-多模态Agent.md`(VLM/ASR/TTS 深度集成)
- [ ] 增加 15 章:`15-AI产品化.md`(产品/UX/商业模式)
- [ ] 增加更多视频教程链接
- [ ] 增加 English 版本
